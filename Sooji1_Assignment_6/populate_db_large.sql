...
the relations Player (approx. 2000 tuples), PlayerBITeam (approx. 2000 tuples),
CurrentTeam (approx. 200 tuples), Game (approx. 2000 tuples), and PlayerPlaysGame
(approx. 2000 tuples).

Tournaments are unique and have a fixed number of specific tournaments, so I did not
add thousands or hundreds of data for this.
*/
...
#Contains ~2000 tuples
LOAD DATA
	LOCAL INFILE "data/PlayerPlaysGame.txt"
    REPLACE INTO TABLE PlayerPlaysGame
    FIELDS TERMINATED BY '|'
    LINES TERMINATED BY '\n';
